export const COMMAND_SPECS = [
  ...
  { name: 'skill', menuDescription: 'List or toggle system skills', help: '/skill [list|enable|disable] inspect or toggle system skills' },
  { name: 'mcp', menuDescription: 'List or toggle MCP servers', help: '/mcp [list|enable|disable] inspect or toggle MCP servers' },
  ...
  { name: 'backend', menuDescription: 'Show or switch backend runtime', help: '/backend [claude|codex|opencode-acp|pi|default] show or switch backend runtime' },
