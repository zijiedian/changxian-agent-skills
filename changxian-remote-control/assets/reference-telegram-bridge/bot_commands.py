...
COMMAND_SPECS: tuple[CommandSpec, ...] = (
    CommandSpec("start", "Show help and available commands", "<code>/start</code> show help and available commands"),
    ...
    CommandSpec("auth", "Unlock execution", "<code>/auth &lt;passphrase&gt;</code> unlock execution"),
    CommandSpec("cmd", "Show or update command prefix", "<code>/cmd</code> show or update command prefix"),
    CommandSpec("setting", "Show or update bridge settings", "<code>/setting</code> show or update runtime settings"),
)
